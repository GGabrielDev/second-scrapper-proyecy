...
TreeNode* WebCrawler::crawl(const std::string& url, int depth) {
    ...
    for (const std::string& link : links) {
        ...
        std::cerr << "  [crawl] Processing link: " << absolute << "\n";
        if (!visited.count(absolute) && isInternal(absolute)) {
